defmodule WineCellar do
  ...
  def filter(cellar, color, opts \\ []) do
    ...
    wines = case Keyword.has_key?(opts, :year) do
      true -> filter_by_year(wines, Keyword.get(opts, :year))
      false -> wines
    end
    wines = case Keyword.has_key?(opts, :country) do
      true -> filter_by_country(wines, Keyword.get(opts, :country)) 
      false -> wines
    end
    wines
  end
