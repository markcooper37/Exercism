defmodule FileSniffer do
  @error_warning "Warning, file format and file extension do not match."
  ...
  def verify(file_binary, extension) do
    if (type = type_from_binary(file_binary)) == type_from_extension(extension) and type != nil, do: {:ok, type}, else: {:error, @error_warning}
  end
end
